...
//
    ...
    public final class LiquidLensView: UIView, AnyLiquidLensView, PlatformDisplayLinkDelegate {
...
//        liquidGlassView.layer.cornerRadius = min(bounds.width, bounds.height) / 2
        ...
        public func synchronization(context _: PlatformDisplayLinkCallbackContext) {
...
//        print(acceleration)
    ...
    public typealias UILiquidLensView = AnyLiquidLensView & UIView
